...
export default function ChickenTacoBowlPage() {
        ...
        <section className="min-w-0 flex-1 px-6 py-8 md:px-10 lg:px-14">
            ...
            <div className="flex flex-col justify-between gap-8 md:flex-row md:items-end">
              <div>
                <div className="flex flex-wrap gap-2">
                  {["LUNCH", "HIGH PROTEIN", "MEAL PREP", "POST-WORKOUT"].map((tag) => (
                    <span
                      key={tag}
          ...
          <section className="grid gap-6 pb-10 xl:grid-cols-[0.9fr_1.1fr]">
            ...
            <div className="rounded-[2rem] border border-[#DED0CB] bg-[#FBF8F6] p-7 md:p-8">
              ...
              <h2 className="mt-3 font-serif text-3xl">
                Build your <span className="italic text-[#A77B73]">taco bowl.</span>
              </h2>
