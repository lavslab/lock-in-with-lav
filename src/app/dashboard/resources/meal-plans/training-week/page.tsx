        ...
        <section className="min-w-0 flex-1 px-6 py-8 md:px-10 lg:px-14">
          ...
          <section className="mt-10 rounded-[2rem] bg-[#211C19] px-8 py-10 text-[#F7F1ED] md:px-10 md:py-12">
            ...
            <p className="mt-3 font-serif text-2xl italic text-[#DDB5AE] md:text-3xl">
              fuel the work. recover. repeat. ♡
            </p>

            <p className="mt-7 max-w-3xl text-sm leading-7 text-[#D5C8C3]">
              A protein-forward week designed for regular strength training. Higher-carb meals are placed around harder sessions to support training and recovery, while easier days stay balanced and flexible.
            </p>

            <div className="mt-8 flex flex-wrap gap-2">
              {["7 DAYS", "HIGH PROTEIN", "TRAINING FUEL", "FLEXIBLE"].map((tag) => (
                <span
                  key={tag}
          ...
          <section className="py-10">
            <div className="rounded-[2rem] border border-[#DED0CB] bg-[#FBF8F6] p-6 md:p-8">
              ...
              <div className="mt-6 grid gap-3 md:grid-cols-3">
                {[
                  ["01", "FOLLOW OR SWAP", "Tap any meal for the recipe. If your workout days move, move the higher-fuel meals with them."],
                  ["02", "ADJUST PORTIONS", "Your energy needs are individual. Add or reduce portions based on your needs, hunger and goals."],
                  ["03", "MOVE THE DAYS", "Lower-body day moved? Shift that day's meals with it. The training pattern matters more than the weekday."],
          ...
          <section className="pb-12">
            <div className="mb-7">
              ...
              <h2 className="mt-3 font-serif text-3xl md:text-4xl">
                ...
                <span className="italic text-[#A77B73]">your training.</span>
              </h2>
            </div>
            ...
            <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-center">
              <div>
                ...
                <p className="mt-3 max-w-2xl text-sm leading-6 text-[#6F5F59]">
                  Prep proteins, rice or potatoes and vegetables ahead of time, then build meals around your training schedule. Repeating a few staples keeps the plan practical.
                </p>
              </div>
          ...
          <section className="pb-14 text-center">
            <p className="font-serif text-2xl italic text-[#A77B73]">
              train hard. eat well. recover. repeat. ♡
            </p>
